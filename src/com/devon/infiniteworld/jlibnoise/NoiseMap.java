...
//        return m_pNoiseMap + (long) x + (long) m_stride * (long) y;
    ...
    /**
     * Returns the amount of jLibNoise.noise.utils. memory allocated for this noise map.
     * <p/>
...
//        return m_pNoiseMap + (long) x + (long) m_stride * (long) y;
     ...
     */
    public float GetValue(int x, int y) throws NotImplementedException {
        if (m_pNoiseMap != null) {
...
//        }
     ...
     * @throws NotImplementedException 
     */
    public void SetValue(int x, int y, float value) throws NotImplementedException {
        if (m_pNoiseMap != null) {
            if (x >= 0 && x < m_width && y >= 0 && y < m_height) {
...
//        delete[] m_pNoiseMap;
     ...
     */
    private void CopyNoiseMap (NoiseMap source) throws NotImplementedException {
