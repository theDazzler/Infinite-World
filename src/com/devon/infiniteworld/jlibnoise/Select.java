...
public class Select extends Module {
	...
	public double GetValue(double x, double y, double z) {
		if (m_pSourceModule[0] == null)
			throw new NoModuleException();
		if (m_pSourceModule[1] == null)
			throw new NoModuleException();
		if (m_pSourceModule[2] == null)
			throw new NoModuleException();
		...
		if (edgeFalloff > 0.0) {
			if (controlValue < (lowerBound - edgeFalloff)) {
				...
				return Utils.LinearInterp(m_pSourceModule[0].GetValue(x, y, z), m_pSourceModule[1].GetValue(x, y, z), alpha);
				...
				alpha = Utils.SCurve3((controlValue - lowerCurve) / (upperCurve - lowerCurve));
				return Utils.LinearInterp(m_pSourceModule[1].GetValue(x, y, z), m_pSourceModule[0].GetValue(x, y, z), alpha);
